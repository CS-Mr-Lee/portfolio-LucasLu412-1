...
public class ConnectFourAI {
	...
	/*
	This method asks the users for their usernames (log in, create new account)...
	 */
	public static void gameStart () {
		...
		while (true) {	
			...
			if (accounts.containsKey(usernameInput)) {		//if the account already exist
				...
				System.out.println("This account is not in our files, please enter a password of your choice to create a new account: ");
				String passwordInput = sc.nextLine();
